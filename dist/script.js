...
window.addEventListener('load',()=>{
    ...
    const intervalId = setInterval(() => {
        ...
        function startClock(){
            ...
            sec2.style.bottom = `${(sec2_val-1)*0.25*10}rem`;
            ...
            document.querySelector('.display_time').innerHTML=`${correntTime.getDate()}/${correntTime.getMonth()}/${correntTime.getFullYear()}`;
